...
namespace EspositoSegundoParcial.Entidades.Utilidades
{
    public static class Validaciones
    {
        ...
        */
        ...
        public static void Validar(ComboBox cb, Label lb)
        {
            if (cb.SelectedIndex < 2) // para que contemple tambien la primer opción, seleccionar.
            {
                throw new Exception("Seleccione un valor para el campo " + lb.Text);
            }
        ...
        public static void Validar(TextBox tb, Label lb)
        {
            if (string.IsNullOrEmpty(tb.Text))
                throw new Exception("Debe completar el campo " + lb.Text);
        }
